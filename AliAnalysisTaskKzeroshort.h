#ifndef AliAnalysisTaskKzeroshort_H
#define AliAnalysisTaskKzeroshort_H
...
//-----------------------------------------------------------------
//      AliAnalysisTaskKzeroshort class
//      ---------------------------------
//
...
class AliAnalysisTaskKzeroshort : public AliAnalysisTaskSE {
 public:
	AliAnalysisTaskKzeroshort();
	AliAnalysisTaskKzeroshort(const char *name);
	virtual ~AliAnalysisTaskKzeroshort();
...
//---------------------------------------------------------------------------------------
 ...
 private:
  ...
  TH1D* fHistInvMassK0ShortAfterSel; //!
  TH1D* fHistInvMassK0ShortBefSel; //!
  ...
  Double_t  fV0Sels[7];           // Array to store the 7 values for the different selections V0 related
   ...
   AliAnalysisTaskKzeroshort(const AliAnalysisTaskKzeroshort&);            // not implemented
   AliAnalysisTaskKzeroshort& operator=(const AliAnalysisTaskKzeroshort&); // not implemented
  
   ClassDef(AliAnalysisTaskKzeroshort, 11);
};
